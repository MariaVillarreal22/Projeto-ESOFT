...
final class HomePanel {
    ...
    private JPanel summaryCard(String title, String value, String description) {
        JPanel card = UiSupport.roundedPanel(AppTheme.PANEL_SOFT, 3, 1, new Insets(14, 14, 14, 14), 0, 6, 10);
    ...
    private void buildUi() {
        rootPanel = UiSupport.panel(AppTheme.BACKGROUND, 3, 1, new Insets(18, 32, 42, 32), 0, 18);
        ...
        overviewPanel = UiSupport.panel(AppTheme.BACKGROUND, 1, 4, new Insets(0, 0, 0, 0), 18, 0);
        rootPanel.add(overviewPanel, UiSupport.constraints(1, 0, 1, 1, GridConstraints.FILL_HORIZONTAL));
        modulesPanel = UiSupport.panel(AppTheme.BACKGROUND, 2, 3, new Insets(0, 0, 0, 0), 18, 18);
