...
final class FasesPanel {
    ...
    private void fillBracket() {
        String[][] rounds = {
                {"16AVOS", "1A vs 2C", "1B vs 3D/E/F", "1C vs 2A", "1D vs 3B/E/F", "1E vs 2F"},
                {"OITAVOS", "Venc. 01 vs Venc. 02", "Venc. 03 vs Venc. 04", "Venc. 05 vs Venc. 06", "Venc. 07 vs Venc. 08"},
                {"QUARTOS", "Venc. O1 vs Venc. O2", "Venc. O3 vs Venc. O4", "Venc. O5 vs Venc. O6"},
    ...
    private JPanel roundColumn(String[] items) {
        JPanel column = UiSupport.roundedPanel(AppTheme.CHIP, items.length, 1, new Insets(14, 12, 14, 12), 0, 12, 12);
    ...
    private JPanel matchBox(String text) {
        JPanel box = UiSupport.roundedPanel(new Color(0x153F7B), 2, 1, new Insets(9, 10, 9, 10), 0, 4, 8);
        box.setPreferredSize(new Dimension(166, 68));
    ...
    private void buildUi(WorldCupTeam selectedTeam) {
        ...
        bracketPanel = UiSupport.panel(AppTheme.BACKGROUND, 1, 5, new Insets(0, 0, 0, 0), 12, 0);
